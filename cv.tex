...
\cvsection[experience]{Zkušenosti}
...
\begin{itemize}
\item Výuka webových aplikací (HTML, CSS, JS, PHP, MySQL) a základů informatiky.
...
\begin{itemize}
\item Úprava konzistence přednáškových prezentací se skriptem předmětu BI-DBS (Databázové systémy), oprava vzorové databáze a oprava překlepů v jazyce LaTeX.
...
\cvskill{C, C++}{3}
\cvskill{Python}{3}
\cvskill{MySQL, PostgreSQL}{3}
\cvskill{Linux (Ubuntu)}{3}
\cvskill{HTML, CSS, PHP}{4}
\cvskill{AutoCAD}{4}
%\divider
