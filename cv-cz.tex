...
\item Metodik ICT,
\item Vývojář školního informačního systému.
\end{itemize}

\divider

\cvevent{Učitel odborných předmětů}{Gymnázium, Střední odborná škola, Základní škola a Mateřská škola pro sluchově postižené, Praha 2, Ječná 27}{Zář 2023 -- Současnost}{Praha, Česká republika}
\begin{itemize}
\item Výuka informačních systémů, grafiky a základů informatiky.
\end{itemize}
...
udržení konzistence referenční databáze a oprava \LaTeX přednášek.
